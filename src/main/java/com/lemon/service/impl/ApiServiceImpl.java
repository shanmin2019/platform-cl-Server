...
public class ApiServiceImpl extends ServiceImpl<ApiMapper, Api> implements ApiService {
    ...
    public Result edit(ApiVO apiVo) {
        ...
        if (queryWrapper!=null){
            ...
            System.out.println("删除queryWrapper--->" + queryWrapper + "成功~");
        }
        ...
        System.out.println("我是所有地参数+--->" + apiRequestParams);
        apiRequestParams.addAll(apiVo.getQueryParams()); //type=1 Query参数 url路径上的
